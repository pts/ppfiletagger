...
#
# tagutil.py
# by pts@fazekas.hu at Sun Aug 31 14:10:24 CEST 2008
#

# Allow importing pysqlite2
import os
import sys
sys.path[0:0] = ['.', '%s/d/py.local' % os.getenv('HOME')]
...
def main(argv):
  ...
  TestTagStore(tagstore)
  TestTagStore(tagdict.SlowMemoryTagStore())
